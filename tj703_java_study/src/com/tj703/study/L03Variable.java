...
public class L03Variable {
    public static void main(String[] args) {
        ...
        //js 변수 : let or var
        //java의 변수 : 타입명시하고 이름
        System.out.println(13*13); //(일반적으로)변수가 등록되지 않은 데이터는 선언할 때 마다 새롭게 만든다.
        ...
        System.out.println(d);//4byte 실수
        System.out.println(d*12);
        System.out.println("최신버전");

        //l=13.3; //java는 컴파일시 오류가 발견되면 실핼되지 않기 위해 class 문서로 컴파일하지 않는다.(컴파일이 오류를 에방)
