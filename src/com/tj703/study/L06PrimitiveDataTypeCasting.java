...
public class L06PrimitiveDataTypeCasting {
    public static void main(String []args){
        ...
        //정수 변수에 더 큰 수(더큰정수,실수)를 casting 형변환 후 대입 (byte,short,int,long)
        ...
        //f=(float)(1e308*1e308); //308승 이상의 실수는 표기하는 것 자체가 컴파일 오류가 발생
        //곱한뒤에 값을 대입하는 것은 컴파일 이후 실행하면서 발생하는 일이기 때문에 컴파일 오류를 무시
